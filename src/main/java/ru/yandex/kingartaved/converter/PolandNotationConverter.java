...
public class PolandNotationConverter {
    ...
    public ArrayList<String> resultArrayAfterConversation(String inputExpression) {
     ...
     */
    private ArrayList<String> convertToPostfix(String inputExpression) {

        UnaryMinusPreparator unaryMinusPreparator = new UnaryMinusPreparator();
        ArrayList<String> validExpressionAfterTransformation = unaryMinusPreparator.resultArrayAfterTransformation(inputExpression);
